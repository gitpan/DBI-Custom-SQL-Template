...
sub tag_processors : ClassObjectAttr {
    ...
    initialize => {
        clone => 'hash', 
        default => sub {{
            '?'             => \&DBI::Custom::SQL::Template::TagProcessor::expand_basic_tag,
            '='             => \&DBI::Custom::SQL::Template::TagProcessor::expand_basic_tag,
            '<>'            => \&DBI::Custom::SQL::Template::TagProcessor::expand_basic_tag,
            '>'             => \&DBI::Custom::SQL::Template::TagProcessor::expand_basic_tag,
            '<'             => \&DBI::Custom::SQL::Template::TagProcessor::expand_basic_tag,
            '>='            => \&DBI::Custom::SQL::Template::TagProcessor::expand_basic_tag,
            '<='            => \&DBI::Custom::SQL::Template::TagProcessor::expand_basic_tag,
            'like'          => \&DBI::Custom::SQL::Template::TagProcessor::expand_basic_tag,
            'in'            => \&DBI::Custom::SQL::Template::TagProcessor::expand_in_tag,
            'insert'        => \&DBI::Custom::SQL::Template::TagProcessor::expand_insert_tag,
            'update'    => \&DBI::Custom::SQL::Template::TagProcessor::expand_update_tag
        }}
    }
}
...
DBI::Custom::SQL::Template - Custamizable SQL Template for DBI::Custom
...
=head1 SYNOPSIS
    ...
    my $sql_tmpl = DBI::Custom::SQL::Template->new;
...
This method create query using by DBI::Custom.
...
If you want to know more, Please see DBI::Custom::SQL::Template source code.

=head2 clone

    # Clone DBI::Custom::SQL::Template object
    $clone = $self->clone;
...
L<http://github.com/yuki-kimoto/DBI-Custom-SQL-Template>
...
1; # End of DBI::Custom::SQL::Template
